...
面向新购沪日 NAT / VDS 套餐的 Debian 12、Debian 13 交付工具。使用纯 Bash 绘制 16 色 BBS 风格终端面板，支持 `← / → / ↑ / ↓ / Enter` 操作，不依赖 `dialog`。
...
```text
╔══════════════════════════════════════════════════════════════════════╗
║  ▓▒░  H U R I   L I N K   C O N S O L E  ░▒▓                     ║
║  沪日合规隧道交付面板 · Debian 12/13 · v1.0.0                      ║
╠══════════════════════════════════════════════════════════════════════╣
║  OS D13  本机 172.16.x.x   公网 203.0.113.x                        ║
║  Mieru 运行中  WireGuard 1套  模式：仅合规隧道                    ║
╚══════════════════════════════════════════════════════════════════════╝

 [ 系统 ]  Mieru  WireGuard  集群  测速  维护
  ▶ 执行完整系统体检
    应用保守 BBR + FQ 优化
    查看端口与服务
